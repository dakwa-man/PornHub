...
async def _(event):
    ...
    packname = f"@nigg2 geng beng"
    packshortname = f"Fafa_gengbeng{userid}"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packname = f"Dakwa_AnimatedStickers"
        packshortname = f"Dakwa_Animated"  # format: Uni_Borg_userid
